...
func Test_Abs(t *testing.T) {
	...
	if got := Abs(int64(math.MinInt64)); got != math.MaxInt64 {
		wantMaxInt64 := int64(math.MaxInt64)
		t.Errorf("Abs(MinInt64) = %d, want MaxInt64 %d", got, wantMaxInt64)
	}
	...
	if got := Abs(int64(math.MaxInt64)); got != math.MaxInt64 {
		wantMaxInt64 := int64(math.MaxInt64)
		t.Errorf("Abs(MaxInt64) = %d, want MaxInt64 %d", got, wantMaxInt64)
	}
}
...
func Test_MinN(t *testing.T) {
	...
	if got := MinN(int64(0), math.MinInt64, math.MaxInt64); got != math.MinInt64 {
		wantMinInt64 := int64(math.MinInt64)
		t.Errorf("MinN int64 boundary = %v, want %v", got, wantMinInt64)
	}
